exports.addEmployeeEmailTemplate = function (name, email, role,password) {
                          ...
                          <div class="p-3">
                              ...
                              <div class="mb-3 text-justify mt-3">
                                  <span class="text-dark">
                                      You have been added as a new employee in the system.
                                  </span>
                                  <br><br>
                                  <span class="text-dark">
                                  ...
                                  <span class="text-dark bolder">
                                      Password: <b>${password}</b>
                                  </span>
                                  <br><br>
                                  <span class="text-dark">
                                      Please make sure to update your password after logging in for the first time.
                                  </span>
                                  <br><br>
                                  <span class="text-dark">
